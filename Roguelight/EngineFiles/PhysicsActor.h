...
public:
	...
	//! @param force is the force vector that is to be applied on the actor
	void ApplyLinearImpulse(DOUBLE2 impulse);
	...
	//! add this object to the contactlistener. This must be al object of a class that is derived from the ContactListener Class
